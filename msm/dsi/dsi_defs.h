 ...
 * @DSI_CMD_SET_PANEL_OD_ON:               Panel od on
 * @DSI_CMD_SET_PANEL_OD_OFF:              Panel od off
 * @DSI_CMD_SET_MAX
 */
enum dsi_cmd_set_type {
	...
	DSI_CMD_SET_DFPS_DELAY_CMD_60,
	DSI_CMD_SET_DFPS_DELAY_CMD_90,
	DSI_CMD_SET_DFPS_DELAY_CMD_120,
	DSI_CMD_SET_DFPS_DELAY_CMD_144,
	...
	DSI_CMD_SET_PANEL_OD_ON,
	DSI_CMD_SET_PANEL_OD_OFF,
	DSI_CMD_SET_MAX
};
